...
<div class="hero"><img src="/wp-content/themes/olympus/images/Sovereign_Viewscreen.jpg" /></div>

<div class="section user-toolbar"><p><a href="<?php echo do_shortcode('[bbpm-messages-link]') ?>">Unread Messages: <?php echo do_shortcode('[bbpm-unread-count]') ?></a> | Current Episode: <a href="http://www.uss-olympus.org/forums/topic/episode-1-the-hallowed-2/">The Hallowed</a></div>
