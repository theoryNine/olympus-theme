...
<div class="section">
   <div class="manifest">
      <div class="department section">
         ...
         <div class="row">
            <div class="mani-field rank"><img src="/wp-content/themes/olympus/images/pips/blank_officer/black.png" /></div><div class="mani-field position"><p class="second-off">Ship's Counselor</p></div><div class="mani-field character"><p><a href="/enlist">Position Available</a></p></div>
         </div>
         <div class="row">
